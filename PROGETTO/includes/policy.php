    ...
    <body>
        ...
        <div class="col-md-4 col-lg-4 col-xl-5 mx-auto mb-md-0 mb-4">
            ...
            <p><i class="fas fa-home me-3">
                I dati personali da Lei inseriti, sono trattati dal proprietario del sito Ristorante La Pineta - Via Gualco, 82 - 16165 Genova (GE) - +39010802772 in qualità di Titolare, per finalità connesse alla fornitura dei servizi da Lei richiesti (a titolo esemplificativo: richiedere informazioni, registrarsi al sito per ricevere vantaggi e offerte, ottenere preventivi, effettuare pagamenti, acquistare beni e riceverli presso un domicilio da Lei indicato, effettuare una prenotazione, scambiare documenti).
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="300">
            <img src="img/clients/Regione-Toscana.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="400">
            <img src="img/clients/comunefirenze.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="500">
            <img src="img/clients/tripadvisor.png" class="img-fluid" alt="">
          </div>
